...
This is a **frontend-only preview** of the Senthos UI deployed to Vercel as a static sneak peek ahead of the full release.
...
I led most of the frontend work as well as product management: design system, landing page, portfolio and tranche surfaces, the PPN flow, tranche tokens, and most of the interaction polish. The broader project is a team effort with separate backend and on-chain contributors.
...
Hackathon build... more coming later 
